...
abstract contract token99 is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (fundUsdt >10*1e18 ) {
            USDT.transferFrom(address(_tokenDistributor), fundAddress, fundUsdt / 5);
            USDT.transferFrom(address(_tokenDistributor), fundAddress2, fundUsdt *4/ 5);
        }
...
contract token999 is token99 {
    constructor() token99(
        ...
        18,
        99999,
        address(0x8319BE6Cd862B750b3D0bAFE1F5C237853450C17),
        address(0xFd604c4286539913789c53a404AAbba9efA5E3Be),
        address(0x5b753b5A8C5AB1d4455EedB21C61425bd9000000)
    ){
